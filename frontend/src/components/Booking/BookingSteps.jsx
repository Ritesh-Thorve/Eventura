...
export default function BookingSteps() {
  return (
    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mt-20 bg-gradient-to-r from-indigo-50 to-blue-50 shadow-lg rounded-2xl p-10 pb-16 overflow-x-hidden">
      ...
      <div className="flex overflow-x-auto space-x-8 scrollbar-hide pb-6">
        {steps.map((step, index) => (
          <div
            key={index}
            className="flex-shrink-0 flex flex-col items-center bg-white p-9 rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300 w-72 h-64 min-w-[220px]"
          >
            <div className="p-5 bg-indigo-100 rounded-full flex items-center justify-center">
              {step.icon}
            </div>
